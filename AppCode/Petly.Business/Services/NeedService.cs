...
public class NeedService
{
    ...
    public async Task<List<ShelterNeedCardViewModel>> GetNeedsAsync(int? currentAccountId, string? role)
    {
        ...
        return needs
            .Select(need => new ShelterNeedCardViewModel
            {
                NeedId = need.NeedId,
                ...
                CanManage = role == "system_admin" || (role == "shelter_admin" && currentAccountId == need.ShelterId)
            })
            .ToList();
    }
